        ...
        return (
            <>
                {devices.map((subitem, subkey) => {
                    ...
                    return (<>
                        <TouchableOpacity key={subkey} style={styles.subCategory} onPress={() => navigation.navigate(SCREEN_CONSTANTS.TRIP_HISTORY_DETAILS, { data: subitem, isMobileTracker:true})} >
